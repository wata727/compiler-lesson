...
int main() {
  ...
  ASSERT(1, ({ struct {char a; char b; char c;} x; x.a=1; x.b=2; x.c=3; x.a; }));
  ASSERT(2, ({ struct {char a; char b; char c;} x; x.a=1; x.b=2; x.c=3; x.b; }));
  ASSERT(3, ({ struct {char a; char b; char c;} x; x.a=1; x.b=2; x.c=3; x.c; }));
  ...
  ASSERT(16, ({ struct t {char a; long b;} x; sizeof(x); }));
  ASSERT(4, ({ struct t {char a; short b;} x; sizeof(x); }));
